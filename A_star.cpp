...
int a_star_branch_and_bound(std::unordered_map<char, std::vector<std::pair<char, int>>> &graph, std::unordered_map<char, int> &heuristicValues, char startNode, char goalNode, int bound);
...
int main() {
    ...
    int result = a_star_branch_and_bound(graph, heuristicValues, 'S', 'G', oracle_distance);
