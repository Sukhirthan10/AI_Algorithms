...
int branch_and_bound_search(std::unordered_map<char, std::vector<std::pair<char, int>>> &graph, char startNode, char goalNode, int bound);
...
int main() {
    ...
    int result = branch_and_bound_search(graph, 'S', 'G', oracle_distance);
